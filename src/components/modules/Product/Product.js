...
export default function Product({ price, discount }) {
    return (
        <div className="relative w-full h-115">
            ...
            <div className="absolute flex flex-col justify-between bg-secondary border border-black/10 rounded-xl md:rounded-2xl h-4/5 w-[calc(100%-20px)] right-[10px] top-4 p-6">
                {/* discount */}
                ...
                <div className="text-center flex flex-col gap-2">
                    ...
                    <div className="flex-center gap-1">
                        ...
                        <p className="text-primary font-danaBold">{discount ? formatNumber(calcDiscountPrice(price, discount)) : formatNumber(price)}</p>
                        <svg class="size-4 text-primary"><use href="#toman"></use></svg>
                    </div>
                </div>
