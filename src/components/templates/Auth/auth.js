                                            ...
                                            <div className="flex items-center">
                                                ...
                                                <div className="flex items-center gap-1 mr-auto">
                                                    <div onClick={resendCode}
                                                        className={`text-sm underline-offset-2 transition-colors ${timer > 0
                                                            ? 'text-black/70 cursor-not-allowed'
                                                            : 'hover:underline text-black/70 hover:text-black cursor-pointer'
                                                            }`}>
                                                        ارسال دوباره
                                                    </div>
                                                    {timer > 0 && (
