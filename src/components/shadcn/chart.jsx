...
function ChartTooltipContent({
  ...
  return (
    <div
      className={cn(
        "bg-white grid min-w-[8rem] items-start gap-1.5 rounded-lg border border-zinc-200 px-2.5 py-1.5 text-xs shadow-xl",
        className
      )}>
              ...
              {formatter && item?.value !== undefined && item.name ? (
                ...
                <>
                  ...
                  <div
                    ...
                    {item.value && (
                      <span
                        className="text-zinc-950 font-mono font-medium tabular-nums ">
